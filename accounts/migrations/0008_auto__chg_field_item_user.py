...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.user'
        db.alter_column(u'accounts_item', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Item.user'
        db.alter_column(u'accounts_item', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default='schmeenarf', to=orm['auth.User']))
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            'tz_offset': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
