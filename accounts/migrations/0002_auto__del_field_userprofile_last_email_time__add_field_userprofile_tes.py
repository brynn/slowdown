...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.last_email_time'
        db.delete_column(u'accounts_userprofile', 'last_email_time')

        # Adding field 'UserProfile.test_section'
        db.add_column(u'accounts_userprofile', 'test_section',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.last_email_time'
        db.add_column(u'accounts_userprofile', 'last_email_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.test_section'
        db.delete_column(u'accounts_userprofile', 'test_section')
    ...
    models = {
        ...
        u'accounts.userprofile': {
            ...
            'test_section': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
