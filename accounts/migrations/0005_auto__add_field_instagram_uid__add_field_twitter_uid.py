...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instagram.uid'
        db.add_column(u'accounts_instagram', 'uid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Twitter.uid'
        db.add_column(u'accounts_twitter', 'uid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instagram.uid'
        db.delete_column(u'accounts_instagram', 'uid')

        # Deleting field 'Twitter.uid'
        db.delete_column(u'accounts_twitter', 'uid')
