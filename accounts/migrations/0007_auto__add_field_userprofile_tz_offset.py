...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.tz_offset'
        db.add_column(u'accounts_userprofile', 'tz_offset',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.tz_offset'
        db.delete_column(u'accounts_userprofile', 'tz_offset')
